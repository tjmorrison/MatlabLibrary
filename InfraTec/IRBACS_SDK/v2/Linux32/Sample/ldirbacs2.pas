...
type
  ...
  T_irbacs64_getParam                = function( const aHandle : PtrUInt; const what :Integer; var Value :Single): Boolean; stdcall;
  T_irbacs64_setParam                = function( const aHandle : PtrUInt; const what :Integer; const Value :Single): Boolean; stdcall;
  ...
  T_irbacs64_getFrameTimeStamp       = function( const aHandle : PtrUInt ): Double; {TSystemTime;} stdcall;
